      ...
      <main className="max-w-7xl mx-auto px-4 pt-24 space-y-8">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 h-full">
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                ...
                <div className="bg-gray-50 p-4 rounded-2xl text-center">
                  <ShieldCheck className="mx-auto text-indigo-500 mb-1" size={20} />
                  <p className="font-bold text-gray-900 truncate text-xs">{provider.experience}</p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <button
                  ...
                  className="flex items-center justify-center gap-3 bg-indigo-600 text-white py-4 rounded-2xl font-bold shadow-lg shadow-indigo-100 hover:bg-indigo-700 transition-all active:scale-95 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-3 bg-white border-2 border-gray-100 text-gray-900 py-4 rounded-2xl font-bold hover:bg-gray-50 transition-all active:scale-95 cursor-pointer"
                >
                  <Computer size={20} /> {t('details_ads.message')}
                </button>

                <button
                  onClick={() => window.open(`https://wa.me/${provider.tel.replace(/[^0-9]/g, '')}`, '_blank')}
                  className="sm:col-span-2 w-full flex items-center justify-center gap-3 bg-[#25D366] text-white py-4 rounded-2xl font-bold hover:opacity-90 transition-all active:scale-[0.98] cursor-pointer"
                >
        ...
        <div className="w-full space-y-4 px-2">
          ...
          <div className="bg-white p-3 rounded-[2.5rem] shadow-sm border border-gray-100 h-[250px] relative overflow-hidden group">
            ...
            {/* Transparent overlay to disable map dragging/zooming */}
